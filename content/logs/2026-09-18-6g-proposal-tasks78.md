...
- 生成《2-1-2项目目标及考核指标-孙彭轩.docx》：项目目标总述 + 8条考核指标逐条展开（数值对齐指南）+ 表2-2成果对应关系 + 表2-3指标分解及测评方式。测评方式落到可操作层面：指标1拒绝率按≥10000次伪造尝试统计，指标4正确率提升按开/关审计对照实验测算，指标6按GB/T 25000.51-2016第三方检测+用户盖章应用证明。
